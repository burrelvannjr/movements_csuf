...
For this assignment, students should see themselves as a seasoned activist working as a consultant for a new/emergent social movement organization. As such, all students will be participating in a unified Google Document where students can add their thoughts in bullet-point fashion. The document should be considered a ``How To'' guide for the hypothetical movement. That is, if the movement actually existed, we could take that document (and our expertise) to the organization to help the group ``get off the ground.'' \newline


\textbf{``Building a Movement'': Reflection Paper (30 points)}\newline
Students will write a 1-2 page reflection on the ``building a movement'' class project, focusing particularly on the ``How To'' guide/Google Document created by the class. Students should reflect on how they view the movement playing out, and address questions such as: Do you envision the movement achieving its goals? Why or why not?(Hint: most of the time, the answer is no... most movements fail to achieve their stated goals... but achieve some combination of success and failure). What are some possible responses the movement could encounter? What are some internal problems the movement could face? This reflection will be due on . No late reflections will be accepted. \newline
...
\subsubsection*{1 - \textit{Introductions; What is a Social Movement?}}
\begin{itemize}
...
\subsubsection*{2 - \textit{Political Context and Opportunities; Resources}}
\begin{itemize}
\item \textbf{Chapter(s)}: 3 (pp. 64-87); 3 (pp. 87-98)
\item \textbf{Article(s)}: Almeida (2003)
\end{itemize} 

\vspace{3pt}

\subsubsection*{3 - \textit{Grievances}}
\begin{itemize}
\item \textbf{Chapter(s)}: 2
\item \textbf{Article(s)}: Van Dyke and Soule (2002); Snow et al. (2005)
\end{itemize}

\vspace{3pt}

\subsubsection*{4 - \textit{Organizations}}
\begin{itemize}
\item \textbf{Article(s)}: Robnett (1996); Staggenborg (1988); Taylor (1989); McVeigh et al. (2014)
\end{itemize}

\vspace{3pt}

\subsubsection*{5 - \textit{Framing and Media}}
\begin{itemize}
\item \textbf{Article(s)}: Snow et al. (2007); Roscigno and Danaher (2001)
\end{itemize}

\vspace{3pt}


\subsubsection*{6 - \textit{Recruitment, Participation, Identity}}
\begin{itemize}
\item \textbf{Chapter(s)}: 4
\item \textbf{Article(s)}: Corrigall-Brown et al. (2009); Einwohner (2006); Futrell and Simi (2004)
\end{itemize}

\vspace{3pt}

\subsubsection*{7 - \textit{Dynamics and Tactics}}
\begin{itemize}
\item \textbf{Chapter(s)}: 5
\item \textbf{Article(s)}: McAdam (1983); Van Dyke (2003)
\item \textbf{Due}: Research Question Quiz (5pm)
\end{itemize}

\vspace{3pt}

\subsubsection*{8 - \textit{``Building A Movement'': Class Project}}
\begin{itemize}
\item \textbf{Activities}: Participation in discussion of movement-building, contribution to course ``How To'' Google Document
\end{itemize}
\vspace{3pt}

\subsubsection*{9 - \textit{Political Consequences/Outcomes}}
\begin{itemize}
\item \textbf{Chapter(s)}: 6 (pp. 202-217)
\item \textbf{Article(s)}: Andrews (2001); Andrews (1997); McAdam and Su (2002)
\item \textbf{Due}: ``Building A Movement'' Reflection Paper (5pm)
\end{itemize}

\vspace{3pt}

\subsubsection*{10 - \textit{Cultural Consequences/Outcomes}}
\begin{itemize}
\item \textbf{Chapter(s)}: 6 (pp. 217-220)
\item \textbf{Article(s)}: Bail (2012); Amenta et al. (2009)
\end{itemize}

\vspace{3pt}

\subsubsection*{11 - \textit{Historical and Contemporary Movements}}
\begin{itemize}
\item \textbf{Activities}: Exposure to historical and contemporary social movements; students encouraged to sit-in on organizational meetings
\end{itemize}

\vspace{3pt}

\subsubsection*{12 - \textit{``Attention to Movements'': Group or Individual Projects}}
\begin{itemize}
...
\subsubsection*{13 - \textit{``Attention to Movements'': Group or Individual Projects}}
\begin{itemize}
\item \textbf{Activities}: Library; gathering data on social movement coverage
\end{itemize}
...
\subsubsection*{15 - \textit{``Attention to Movements'': Group or Individual Presentations}\newline}

\vspace{3pt}

\subsubsection*{16 - \textit{``Attention to Movements'': Group or Individual Presentations}\newline}

\vspace{3pt}

\subsubsection*{Finals Week}
\begin{itemize}
\item \textbf{Due}: ``Attention to Movements'': Group or Individual Paper
\end{itemize}
